...
describe("ProductRepository test", () => {
    ...
    it("should create a product", async () => {
        ...
        const productDb = await ProductModel.findOne({
            where: { id: productProps.id.toString() },
        });
        expect(productProps.id.toString()).toEqual(productDb!.id);
    ...
    it("should find a product", async () => {
        ...
        const product = await productRepository.findRequired("1");
        expect(product!.id.toString()).toEqual("1");
